...
module.exports = {
    up: async (queryInterface, Sequelize) => {
        // 1. Seed Allcodes (Role, Status, Gender, Category, Brand, etc.)
        ...
        await queryInterface.bulkInsert('Users', [
            {
                email: 'admin@gmail.com', // Standard Admin
            ...
            {
                email: 'admin@admin', // As requested specially
                password: hashPassword('1234'),
                firstName: 'Requested',
                lastName: 'Admin',
                address: 'Hanoi',
        ...
        await queryInterface.bulkInsert('Products', [
            {
                name: 'Figure Son Goku',
                contentHTML: '<p>Super Saiyan Son Goku Figure</p>',
                contentMarkdown: 'Super Saiyan Son Goku Figure',
                statusId: 'S1',
                categoryId: 'C1',
                view: 100,
                madeby: 'Japan',
            ...
            },
            {
                ...
                contentHTML: '<p>Samsung Galaxy S24 Ultra</p>',
                contentMarkdown: 'Samsung Galaxy S24 Ultra',
                statusId: 'S1',
                categoryId: 'C2',
                view: 50,
                madeby: 'Korea',
